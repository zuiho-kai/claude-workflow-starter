...
```text
latency_out=/home/wzr/hy3_ar_bench_20260602_main3767_aronly_tp2_minpatch/summary.json
profile_out=/home/wzr/hy3_ar_bench_20260602_main3767_aronly_tp2_profile_rpc_img/report.md
...
3. **`ops_rank*.xlsx` 存在不等于 CUDA 算子表可用**
   ...
   ```text
   /home/wzr/hy3_ar_bench_20260602_main3767_aronly_tp2_profile_rpc_img/top_gpu_kernels.json
   ```
