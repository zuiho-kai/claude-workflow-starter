...
Remote: root@47.79.124.13:31449
Worktree: /data/wzr/wt-pr4041-023-groupbatch
Python: /data/wzr/.venv-vllm023-baseline/bin/python
vLLM: 0.23.0
...
Run dir: /data/wzr/pr4041_512_step_sdpa_rerun_20260615_180116/run
Result JSON: /data/wzr/pr4041_512_step_sdpa_rerun_20260615_180116/run/results/diffusion_result_test_pr4041_512_step_grouped_sdpa_batch_2_4_8_20260615-180205.json
...
1. 用户在仓库上下文里说“落盘 / 记录 / 复盘”时，先按 `CLAUDE.md` 写本仓 `memory/`、`.claude_errors/` 或 `docs/`；禁止默认写 `C:\Users\user\.codex`。
