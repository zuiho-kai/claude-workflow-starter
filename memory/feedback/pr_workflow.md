...
| PR template, rendered body checks, public reproduction shape | [pr_body_evidence.md](pr_workflow/pr_body_evidence.md) |
| PR performance / accuracy / image evidence, head/run/artifact provenance | [pr_body_provenance.md](pr_workflow/pr_body_provenance.md) |
| New model PR evidence split: source parity / stub smoke / real checkpoint | [pr_body_model_evidence.md](pr_workflow/pr_body_model_evidence.md) |
| Public PR body/comment privacy boundary | [pr_body_privacy.md](pr_workflow/pr_body_privacy.md) |
