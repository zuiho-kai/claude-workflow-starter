---
name: vllm-omni Omni() 直接实例化必须 nullify EngineArgs 顶层默认
description: bypass argparse 直接 Omni() 调用要先把 EngineArgs 顶层 tp/pp/prefix_caching 等字段清成 None，否则跟 stage_config yaml 冲突，stage worker 设备分配错乱
type: feedback
---
