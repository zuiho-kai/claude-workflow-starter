---
name: HunyuanImage-3 官方 run_image_gen.py demo 运行手册
description: 在新容器跑 Tencent-Hunyuan/HunyuanImage-3.0 仓库的 run_image_gen.py（官方 PyTorch demo）会踩的依赖 + JIT timing + 切分方式，避免误诊"卡死"
type: reference
---
...
```bash
cd /root/HunyuanImage-3.0  # 必须从 repo 根跑（导 hunyuan_image_3 / PE 包靠相对路径）
