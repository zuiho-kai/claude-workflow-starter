---
name: 接 HF trust_remote_code 模型做 baseline 对齐时反复犯的错
description: 必先 grep 官方 README/demo 找入口、读 requirements.txt 别猜版本、改 snapshot 不改 modules cache、有 runbook 直接照抄
type: feedback
---
