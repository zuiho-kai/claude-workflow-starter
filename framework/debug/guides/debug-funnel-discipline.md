...
- 相邻：[execution_principles](execution-principles.md)（用户给方案直接执行）、[conclusion_discipline](conclusion-discipline.md)（推理 vs 实测前缀）、[style_bias_debug_methodology](../../../repos/vllm-omni/debug/guides/style-bias-debug.md)（静态 diff > dump）
