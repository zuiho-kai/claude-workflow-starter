...
- PR #3444 review iteration：[Hunyuan KV reuse 错题](../../../repos/vllm-omni/models/hunyuan-image3/incidents/2026-05-13-kv-reuse-orchestrator.md)（Optimization leftover 段）
- 上位原则：F3（只碰任务直接涉及的代码）
- 相邻：[pr_workflow](../../../repos/vllm-omni/git/guides/pr-workflow.md)（PR scope 守门）、[debug_funnel_discipline](../../debug/guides/debug-funnel-discipline.md)（受阻时回静态，不向外扩散）
- 派生硬规则：CLAUDE.md F8
